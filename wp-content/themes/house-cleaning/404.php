...
<div class="header-image-box text-center">
  <div class="container">
    <?php if ( get_theme_mod('house_cleaning_header_page_title' , true)) : ?>
      <h1><?php esc_html_e('404 Error!', 'house-cleaning'); ?></h1>
    <?php endif; ?>
...
<div id="content">
	<div class="container">
		<div class="py-5 text-center">
			<p><?php esc_html_e('The page you are looking for may have been moved, deleted, or possibly never existed.', 'house-cleaning'); ?></p>
			<?php get_search_form(); ?>
		</div>
	</div>
</div>
